 ...
 */
function makeGraph(segments : BusSegment[]) : any {
 ...
 */
async function loadGraphFromFile(filename: string) {
...
export default { makeGraph: makeGraph, loadGraphFromFile: loadGraphFromFile };